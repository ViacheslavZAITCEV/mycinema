export const Logo = () => {
	return (
		<svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			viewBox="0 0 274.1 53.3" xmlSpace="preserve">

			<title>Fichier 3</title>
			<g>
				<g id="Calque_1-2">
					<path fill="#EF3555" d="M119.6,12.2h3.9V17c1.9-3.4,5.5-5.6,9.4-5.6c3.1-0.1,6,1.1,8.1,3.4c0.8,1,1.4,2,1.9,3.1
			...
			c-1.5-2.1-3.9-3.3-6.5-3.2c-2.5-0.1-4.8,1-6.3,3c-1.4,2.1-2.1,4.6-2,7.2V42h-4.1L119.6,12.2L119.6,12.2z"/>
					<path fill="#EF3555" d="M169,26.3c0.2-8.7,7.5-15.6,16.2-15.4c8.4,0.2,15.2,7,15.4,15.4c-0.2,8.7-7.5,15.6-16.2,15.4
			...
			c0.2-6.5-4.9-11.9-11.4-12.1c-6.5-0.2-11.9,4.9-12.1,11.4C173.1,25.9,173.1,26.1,173.1,26.4L173.1,26.4z"/>
					<path fill="#EF3555" d="M216.7,42h-4.2l-11.7-29.8h4.3l9.5,24.8l9.6-24.8h4.3L216.7,42z" />
					<path fill="#EF3555" d="M233.2,12.2h4.1V42h-4.1V12.2z" />
					<path fill="#EF3555" d="M235.3,0c-1.8,0-3.2,1.5-3.3,3.3s1.3,3.4,3.1,3.5s3.4-1.3,3.5-3.1c0-0.1,0-0.2,0-0.4
			C238.5,1.5,237.1,0,235.3,0z"/>
					<path fill="#EF3555" d="M246.8,29h27.4l-0.1-3.5c-1-8.7-8.8-14.9-17.5-13.9c-7.9,0.9-14,7.6-14,15.6v0.1c-0.2,8.5,6.6,15.5,15.1,15.7
			...
			L258.4,15.2z"/>
					<path fill="#172847" d="M74.2,24.6c-3.6-1-5.7-2.2-5.8-5c-0.1-2.6,1.9-4.8,5.2-4.8c3,0,5.1,1.7,5.1,4.9h4c-0.3-6-4.9-8.3-9.1-8.3
			...
			c-3.2,0.2-6-2.3-6.1-5.5c0-0.1,0-0.3,0-0.4h-4c0,6.3,5.4,9.3,10.2,9.3c5.6,0,10.1-4,9.9-9.4C83.3,27,78.6,25.8,74.2,24.6z"/>
					<polygon fill="#172847" points="110.6,12.2 100.9,36.3 91.6,12.2 87.2,12.2 98.7,41.4 93.6,53.3 98,53.3 115,12.2 		" />
					<path fill="#172847" d="M55.1,16.4c-3-3.3-7.3-5.1-11.8-5.1v3.9c6.4-0.1,11.6,5,11.7,11.4c0,0.1,0,0.3,0,0.4v0.1
			...
			C4.9,19.3,9.9,14.9,15.8,15z"/>
					<polygon fill="#EF3555" points="38.1,18.6 52.4,26.9 38.1,35.1 		" />
				</g>
			</g>
		</svg>
	)
